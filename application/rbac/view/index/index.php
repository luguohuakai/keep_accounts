...
<!--                </ul>-->
                ...
                <fieldset>
                    ...
                    {volist name="v" id="vv"}
                    <div>
                        <span id="auth_{$vv.id}" data-auth_id="{$vv.id}" class="label label-default">{$vv['name']}</span>
                    </div>
                    {/volist}
                </fieldset>
                {/volist}
...
<script>
    $("#admin>li").click(function () {
        ...
        $("#auth>fieldset>div>span").removeClass('label-success').removeClass('label-default').addClass('label-default');
...
//                    }
                    for (var j in auth) {
                        for (var i in auth[j]) {
                            $("#auth_" + auth[j][i].auth_id).removeClass('label-default').addClass('label-success');
                        }
                    }
                } else {
                    toastr.error(e.msg);
