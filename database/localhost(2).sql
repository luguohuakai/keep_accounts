...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-05-31 21:07:33
-- 服务器版本： 5.7.14
-- PHP Version: 7.0.10
...
(5, 0, 1494572975, 1494572975, '苹果', '12.00', '1', 1),
(6, 1495285066, 1495285066, 1495285066, '大米', '29.89', '1', 1),
(7, 1495285164, 1495285164, 1495285164, '菠萝', '8.00', '1', 1),
(8, 1495285202, 1495285202, 1495285202, '苹果', '20.90', '2', 1),
(9, 1495026026, 1495285239, 1495285239, '面，肉，鸡蛋', '29.89', '2', 1),
(10, 1495112626, 1495285436, 1495285436, '苹果', '12.00', '1', 1),
(11, 1495285443, 1495285456, 1495285456, '菠萝', '8.00', '2', 1);
...
(212, '13', 2, 1496148096, 1496148151),
(213, '1123', 2, 1496148137, 1496149448),
(214, '11', 22, 1496149424, 1496149424);
...
--
ALTER TABLE `ac_bill`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '账单ID', AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `sys_role`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=215;
--
...
--
ALTER TABLE `tp_menu`
  MODIFY `id` smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID', AUTO_INCREMENT=15;
